...
func (view *UtxoViewpoint) AddTxOut(tx *czzutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *czzutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) addInputUtxos(source utxoView, block *czzutil.Block) error {
...
func addTxOuts(view utxoView, tx *czzutil.Tx, blockHeight int32, overwrite bool) error {
...
func spendTransactionInputs(view utxoView, tx *czzutil.Tx, stxos *[]SpentTxOut) error {
...
func connectTransaction(view utxoView, tx *czzutil.Tx, blockHeight int32, stxos *[]SpentTxOut, overwrite bool) error {
...
func connectTransactions(view utxoView, block *czzutil.Block, stxos *[]SpentTxOut, overwrite bool) error {
...
func disconnectTransactions(view utxoView, block *czzutil.Block, stxos []SpentTxOut) error {
