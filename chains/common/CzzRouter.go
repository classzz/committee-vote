...
//
// Solidity: function swapAndBurnEthWithPath(uint256 _amountInMin, uint256 ntype, string toToken, address routerAddr, address[] path, uint256 deadline) payable returns()
func (_Common *CommonTransactor) SwapAndBurnEthWithPath(opts *bind.TransactOpts, _amountInMin *big.Int, ntype *big.Int, toToken string, routerAddr common.Address, path []common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Common.contract.Transact(opts, "swapAndBurnEthWithPath", _amountInMin, ntype, toToken, routerAddr, path, deadline)
}

// SwapAndBurnEthWithPath is a paid mutator transaction binding the contract method 0x22e1e609.
//
// Solidity: function swapAndBurnEthWithPath(uint256 _amountInMin, uint256 ntype, string toToken, address routerAddr, address[] path, uint256 deadline) payable returns()
func (_Common *CommonSession) SwapAndBurnEthWithPath(_amountInMin *big.Int, ntype *big.Int, toToken string, routerAddr common.Address, path []common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Common.Contract.SwapAndBurnEthWithPath(&_Common.TransactOpts, _amountInMin, ntype, toToken, routerAddr, path, deadline)
}

// SwapAndBurnEthWithPath is a paid mutator transaction binding the contract method 0x22e1e609.
//
// Solidity: function swapAndBurnEthWithPath(uint256 _amountInMin, uint256 ntype, string toToken, address routerAddr, address[] path, uint256 deadline) payable returns()
func (_Common *CommonTransactorSession) SwapAndBurnEthWithPath(_amountInMin *big.Int, ntype *big.Int, toToken string, routerAddr common.Address, path []common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Common.Contract.SwapAndBurnEthWithPath(&_Common.TransactOpts, _amountInMin, ntype, toToken, routerAddr, path, deadline)
}
...
// SwapTokenForEthWithPath is a paid mutator transaction binding the contract method 0xa3f11965.
//
// Solidity: function swapTokenForEthWithPath(address _to, uint256 _amountIn, uint256 mid, uint256 gas, address routerAddr, address[] path, uint256 deadline) payable returns()
func (_Common *CommonTransactor) SwapTokenForEthWithPath(opts *bind.TransactOpts, _to common.Address, _amountIn *big.Int, mid *big.Int, gas *big.Int, routerAddr common.Address, path []common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Common.contract.Transact(opts, "swapTokenForEthWithPath", _to, _amountIn, mid, gas, routerAddr, path, deadline)
}

// SwapTokenForEthWithPath is a paid mutator transaction binding the contract method 0xa3f11965.
//
// Solidity: function swapTokenForEthWithPath(address _to, uint256 _amountIn, uint256 mid, uint256 gas, address routerAddr, address[] path, uint256 deadline) payable returns()
func (_Common *CommonSession) SwapTokenForEthWithPath(_to common.Address, _amountIn *big.Int, mid *big.Int, gas *big.Int, routerAddr common.Address, path []common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Common.Contract.SwapTokenForEthWithPath(&_Common.TransactOpts, _to, _amountIn, mid, gas, routerAddr, path, deadline)
}

// SwapTokenForEthWithPath is a paid mutator transaction binding the contract method 0xa3f11965.
//
// Solidity: function swapTokenForEthWithPath(address _to, uint256 _amountIn, uint256 mid, uint256 gas, address routerAddr, address[] path, uint256 deadline) payable returns()
func (_Common *CommonTransactorSession) SwapTokenForEthWithPath(_to common.Address, _amountIn *big.Int, mid *big.Int, gas *big.Int, routerAddr common.Address, path []common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Common.Contract.SwapTokenForEthWithPath(&_Common.TransactOpts, _to, _amountIn, mid, gas, routerAddr, path, deadline)
}

// SwapTokenWithPath is a paid mutator transaction binding the contract method 0xf0dca0e1.
//
// Solidity: function swapTokenWithPath(address _to, uint256 _amountIn, uint256 mid, uint256 gas, address routerAddr, address[] userPath, address[] gasPath, uint256 deadline) payable returns()
func (_Common *CommonTransactor) SwapTokenWithPath(opts *bind.TransactOpts, _to common.Address, _amountIn *big.Int, mid *big.Int, gas *big.Int, routerAddr common.Address, userPath []common.Address, gasPath []common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Common.contract.Transact(opts, "swapTokenWithPath", _to, _amountIn, mid, gas, routerAddr, userPath, gasPath, deadline)
}

// SwapTokenWithPath is a paid mutator transaction binding the contract method 0xf0dca0e1.
//
// Solidity: function swapTokenWithPath(address _to, uint256 _amountIn, uint256 mid, uint256 gas, address routerAddr, address[] userPath, address[] gasPath, uint256 deadline) payable returns()
func (_Common *CommonSession) SwapTokenWithPath(_to common.Address, _amountIn *big.Int, mid *big.Int, gas *big.Int, routerAddr common.Address, userPath []common.Address, gasPath []common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Common.Contract.SwapTokenWithPath(&_Common.TransactOpts, _to, _amountIn, mid, gas, routerAddr, userPath, gasPath, deadline)
}

// SwapTokenWithPath is a paid mutator transaction binding the contract method 0xf0dca0e1.
//
// Solidity: function swapTokenWithPath(address _to, uint256 _amountIn, uint256 mid, uint256 gas, address routerAddr, address[] userPath, address[] gasPath, uint256 deadline) payable returns()
func (_Common *CommonTransactorSession) SwapTokenWithPath(_to common.Address, _amountIn *big.Int, mid *big.Int, gas *big.Int, routerAddr common.Address, userPath []common.Address, gasPath []common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Common.Contract.SwapTokenWithPath(&_Common.TransactOpts, _to, _amountIn, mid, gas, routerAddr, userPath, gasPath, deadline)
}
