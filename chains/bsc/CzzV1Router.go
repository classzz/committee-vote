...
// SwapAndBurnBsc is a paid mutator transaction binding the contract method 0xfe9c178d.
//
// Solidity: function swapAndBurnBsc(uint256 _amountInMin, uint256 ntype, string toToken, address routerAddr, address WethAddr, uint256 deadline) payable returns()
func (_Bsc *BscTransactor) SwapAndBurnBsc(opts *bind.TransactOpts, _amountInMin *big.Int, ntype *big.Int, toToken string, routerAddr common.Address, WethAddr common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Bsc.contract.Transact(opts, "swapAndBurnBsc", _amountInMin, ntype, toToken, routerAddr, WethAddr, deadline)
}

// SwapAndBurnBsc is a paid mutator transaction binding the contract method 0xfe9c178d.
//
// Solidity: function swapAndBurnBsc(uint256 _amountInMin, uint256 ntype, string toToken, address routerAddr, address WethAddr, uint256 deadline) payable returns()
func (_Bsc *BscSession) SwapAndBurnBsc(_amountInMin *big.Int, ntype *big.Int, toToken string, routerAddr common.Address, WethAddr common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Bsc.Contract.SwapAndBurnBsc(&_Bsc.TransactOpts, _amountInMin, ntype, toToken, routerAddr, WethAddr, deadline)
}

// SwapAndBurnBsc is a paid mutator transaction binding the contract method 0xfe9c178d.
//
// Solidity: function swapAndBurnBsc(uint256 _amountInMin, uint256 ntype, string toToken, address routerAddr, address WethAddr, uint256 deadline) payable returns()
func (_Bsc *BscTransactorSession) SwapAndBurnBsc(_amountInMin *big.Int, ntype *big.Int, toToken string, routerAddr common.Address, WethAddr common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Bsc.Contract.SwapAndBurnBsc(&_Bsc.TransactOpts, _amountInMin, ntype, toToken, routerAddr, WethAddr, deadline)
}
...
// SwapTokenForBsc is a paid mutator transaction binding the contract method 0xcf2df37d.
//
// Solidity: function swapTokenForBsc(address _to, uint256 _amountIn, uint256 mid, uint256 gas, address routerAddr, address WethAddr, uint256 deadline) payable returns()
func (_Bsc *BscTransactor) SwapTokenForBsc(opts *bind.TransactOpts, _to common.Address, _amountIn *big.Int, mid *big.Int, gas *big.Int, routerAddr common.Address, WethAddr common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Bsc.contract.Transact(opts, "swapTokenForBsc", _to, _amountIn, mid, gas, routerAddr, WethAddr, deadline)
}

// SwapTokenForBsc is a paid mutator transaction binding the contract method 0xcf2df37d.
//
// Solidity: function swapTokenForBsc(address _to, uint256 _amountIn, uint256 mid, uint256 gas, address routerAddr, address WethAddr, uint256 deadline) payable returns()
func (_Bsc *BscSession) SwapTokenForBsc(_to common.Address, _amountIn *big.Int, mid *big.Int, gas *big.Int, routerAddr common.Address, WethAddr common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Bsc.Contract.SwapTokenForBsc(&_Bsc.TransactOpts, _to, _amountIn, mid, gas, routerAddr, WethAddr, deadline)
}

// SwapTokenForBsc is a paid mutator transaction binding the contract method 0xcf2df37d.
//
// Solidity: function swapTokenForBsc(address _to, uint256 _amountIn, uint256 mid, uint256 gas, address routerAddr, address WethAddr, uint256 deadline) payable returns()
func (_Bsc *BscTransactorSession) SwapTokenForBsc(_to common.Address, _amountIn *big.Int, mid *big.Int, gas *big.Int, routerAddr common.Address, WethAddr common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Bsc.Contract.SwapTokenForBsc(&_Bsc.TransactOpts, _to, _amountIn, mid, gas, routerAddr, WethAddr, deadline)
}
